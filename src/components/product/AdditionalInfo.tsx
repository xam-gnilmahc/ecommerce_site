...
const AdditionalInfo: React.FC<AdditionalInfoProps> = ({ product_reviews }) => {
  const DEFAULT_AVATAR =
    'https://thumbs.dreamstime.com/b/default-avatar-profile-vector-user-profile-default-avatar-profile-vector-user-profile-profile-179376714.jpg';

  const [activeTab, setActiveTab] = useState<string>('aiTab1');
  ...
  const openViewer = (mediaArray: string[], index: number = 0) => {
