...
export default function Home() {
  ...
  const handleKey = (e) => { if (e.key === "Enter") go(search); };
  ...
  return (
    <div className="hp-root">
      ...
      <section className="hp-hero">
        ...
        {/* BIG SEARCH */}
        <motion.div className={`hp-search-wrap ${focused ? "hp-search-wrap--on" : ""}`} {...stagger(2)}>
        ...
        <motion.div className="hp-hot" {...stagger(3)}>
          <span className="hp-hot-label"><FiTrendingUp /> Trending:</span>
          {HOT_SEARCHES.map((h) => (
            <button key={h} className="hp-hot-chip" onClick={() => go(h)}>{h}</button>
          ))}
        </motion.div>
      ...
      <section className="hp-section">
        ...
        <div className="hp-deals-row">
          ...
          >
            ...
            <div className="hp-deal-title">Laptops &<br />MacBooks</div>
            <div className="hp-deal-sub">Shop the best deals on premium laptops</div>
            <button className="hp-deal-cta">Shop now <FiArrowRight /></button>
