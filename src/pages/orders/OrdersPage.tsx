...
import { useUserOrders } from '../../tanstack/orders';
...
const OrdersPage: React.FC = () => {
  ...
  const orders = useMemo(
    () => (allOrders as any[]).filter((o: any) => o.status !== 'Cancelled'),
    [allOrders]
  );
  ...
  const visibleOrders = (): any[] => {
    switch (statusFilter) {
      ...
      case 'confirmed':
        return orders.filter((o: any) => o.status === 'Confirmed' || o.status === 'Packed');
      case 'shipped':
        return orders.filter((o: any) => o.status === 'Shipped Out');
      case 'out-for-delivery':
        return orders.filter((o: any) => o.status === 'Out for Delivery');
      case 'delivered':
                  ...
                  >
                    ...
                    <div className="order-card-band">
                      ...
                      <div className="band-col band-col--ship">
                        ...
                        <span className="band-value band-ship-name">
                    ...
                    <div className="order-card-body">
                      ...
                      <div className="product-list">
                        {order.order_items?.slice(0, 2).map((item: OrderItem, i: number) => (
