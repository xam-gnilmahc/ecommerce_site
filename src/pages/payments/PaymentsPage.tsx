...
const PaymentSetupPage: React.FC = () => {
  ...
  const handleToggle = (method: keyof PaymentOptions) => {
        ...
        <div className="container">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <motion.div initial={{ y: 40 }} animate={{ y: 0 }} transition={{ duration: 0.4 }}>
              ...
              {[
                { id: 'googlePay' as const, label: 'Google Pay', icon: <FaGooglePay size={28} /> },
                { id: 'applePay' as const, label: 'Apple Pay', icon: <FaApplePay size={28} /> },
                {
                  id: 'card' as const,
